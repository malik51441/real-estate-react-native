import { View, Text, ScrollView, Image, TouchableOpacity, Dimensions, ActivityIndicator, SafeAreaView } from 'react-native';
    ...
    return (
        <View className="flex-1 bg-white">
            ...
            <ScrollView className="flex-1">
                {/* Custom Header */}
                <SafeAreaView className="absolute z-10 w-full flex-row justify-between items-center px-4 pt-3">
                    <TouchableOpacity 
                    ...
                    <View className="flex-row gap-4">
                        ...
                        <TouchableOpacity className="bg-black/30 p-3 rounded-full">
                            <Image source={icons.send} className="w-6 h-6 tint-white" />
                        </TouchableOpacity>
                    </View>
                </SafeAreaView>
